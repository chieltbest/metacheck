...
namespace mc {
	namespace detail {
		...
		using make_pass_minify = minify_result<Case, 0>;
		...
		using first_minified = kmpl::call<
		        kmpl::find_if<kmpl::logical_not<>, kmpl::front<minify<>>,
		                      kmpl::always<kmpl::call<kmpl::front<kmpl::cfe<make_pass_minify>>,
		                                              Tests...>>>,
		        Tests...>;
