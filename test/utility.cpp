...
const auto repeat_all_t_test = mc::test<repeat_all_t, 100, mc::gen::anything>;
...
const auto utility_section_obj = mc::evaluate(mc::section("utility", type_name_not_empty_test));
